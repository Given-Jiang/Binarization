set TESTBENCH "tb_Binarization"
set DUT "dut"
set SIMDATA "Binarization.simdata.tcl"
set outputdir "hdl"
set mdldir ".."
set importdir "../DSPBuilder_Binarization_import"
set wysiwyglist "../Binarization_msim_family_list.tcl"
